...
//Inside of addItem, invoke displayData() which is a function we created that takes care of some 
//of the leg work unrelated to this module.
...
function removeItem(index) {
    groceries[i].splice(-1,1)
    displayData();
}

//////////////////STEP 6////////////////////
//Create a function called 'checkGroceryCount'. 
//Inside of the function check the total number of groceries you need to get 
//using .length. Using an else/if statement, check if the number is greater than or equal to 5, 
