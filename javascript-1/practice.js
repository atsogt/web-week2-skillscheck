...
//and love which will be a string of something you love. Have the function 
//take the two parameters and retrun a string that says "NAMEPARAM loves LOVEPARAM" with the appropriate parameters in the string. e.g. "Bryan loves skateboarding"
...
// Create an object called 'me' that has these keys with the correct values: firstName, state, age, greeter. firstName will be your name as a string. 
//state will be your current state or providence as a string. age will be your age as a number. 
...
//Create a new array inside of bigOrSmall called 'answers'. Loop over the passed in arr param. If the number is GREATER than 100, 
//push 'big' as a string to the answers array. If the number is LESS than or EQUAL to 100, push 'small' as a string to the answers 
//array. Return the answers array inside of the function
...
// Below is an array, myNumbers. We will be using .map, .filter, .reduce and 
//.forEach to manipulate the array in some form
const myNumbers = [3, 55, 788, 2, 1]


//////////////////PROBLEM 14////////////////////

/* First, with an arrow function let's use .map to create a new array that doubles each number. 
...
// Now lets use .filter and an arrow function to only get the nubmer(s) greater than 100. 
//Use an arrow function and call the new array 'filtered'
...
// Code Here
let total = myNumbers.reduce((acc, value) => acc + value)
//////////////////PROBLEM 17////////////////////
...
//Let's go ahead and change everyone's name in the notGeorge array to George using .map and an arrow function. 
...
//Call the new array 'totallyAwesome'. Use .reduce and an arrow function

// Code Here
let totallyAwesome = people.reduce((acc, val) => acc + val )
